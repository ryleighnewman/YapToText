...
struct BeepNotice: View {
    /// Home has room for one line, the Dictation page has room for the whole explanation.
    var brief = false

    var body: some View {
        VStack(alignment: .leading, spacing: 6) {
            Caption(brief
                    ? "Some apps beep when this reads your cursor. Turning Alert volume down in Sound settings silences it."
